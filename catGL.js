...
CatGL.Object.prototype={
	...
	draw:function(){
		CatGL.setAttribute('att_pos',this.posBuffer,3);
		CatGL.setAttribute('att_nor',this.norBuffer,3);
		CatGL.setAttribute('att_col',this.colBuffer,3);
...
CatGL.Texture = function( _url ){

	this.texture = gl.createTexture();

	this.img = new Image();

	this.img.texture = this;
	...
	this.img.onload = function(){
		...
		gl.bindTexture(gl.TEXTURE_2D,t);
		gl.texImage2D(gl.TEXTURE_2D,0,gl.RGBA,gl.RGBA,gl.UNSIGNED_BYTE,this.texture.img);
		gl.texParameteri(gl.TEXTURE_2D,gl.TEXTURE_MAG_FILTER,gl.LINEAR);
		gl.texParameteri(gl.TEXTURE_2D,gl.TEXTURE_MIN_FILTER,gl.LINEAR);
